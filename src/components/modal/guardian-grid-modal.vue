      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Add Guardian</button>
          </div>
        </form>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="mb-0">
                  <label class="form-label">Child</label>
                  <vue-select
                    :options="EditJanetGurdmodel"
                    id="editjanetgurdmodel"
                    placeholder="Janet"
                  />
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="d-flex align-items-center mb-3">
                  <span class="avatar avatar-xl me-2">
                    <img src="@/assets/img/guardians/guardian-01.jpg" alt="img" />
                  </span>
          ...
          <div class="border rounded p-4 pb-1 mb-3">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
              ...
              <div class="d-flex align-items-center">
                <a href="javascript:void(0);" class="btn btn-light mb-3 me-3">Add Fees</a>
                <router-link to="/students/student-details" class="btn btn-primary mb-3"
          ...
          <div class="border rounded p-4 pb-1 mb-3">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
              <div class="d-flex align-items-center mb-3">
                ...
                <div class="ms-2">
                  <p class="mb-0">
                    <router-link to="/students/student-details">Joann</router-link>
                  </p>
                  <span>IV, B</span>
                </div>
              </div>
...
export default {
  data() {
    return {
      JanetGurdmodel: ["Janet", "Joann", "Kathleen", "Gifford"],
      EditJanetGurdmodel: ["Janet", "Joann", "Kathleen", "Gifford"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/guardians/guardian-gird");
    },
  },
};
</script>
