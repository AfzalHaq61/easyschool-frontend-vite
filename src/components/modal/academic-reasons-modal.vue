            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="mb-3">
                  ...
                  <vue-select :options="RoleAcad" id="roleacad" placeholder="Select" />
                </div>
...
export default {
  data() {
    return {
      RoleAcad: ["Select", "Teacher", "Student", "Staff"],
      EditRoleAcad: ["Select", "Teacher", "Student", "Staff"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/academic/academic-reasons");
    },
  },
};
</script>
