          ...
          <form @submit.prevent="submitForm">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="mb-3">
                    ...
                    <vue-select :options="Statve" id="statve" placeholder="Select" />
                  </div>
                  <div
            ...
            <div class="modal-btn text-end">
              <a
                ...
                >Cancel</a
              >
              <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Add State</button>
            </div>
          </form>
        </div>
      </div>
...
export default {
  data() {
    return {
      Statve: ["Select", "United States", "Germany", "Canda", "Australia"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/user/roles-permission");
    },
    submitFormOne() {
