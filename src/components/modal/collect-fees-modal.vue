            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <vue-select :options="FeeSBus" id="feesbus" placeholder="Select" />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="mb-3">
...
export default {
  data() {
    return {
      ...
      FeeSBus: ["Select", "Tuition Fees", "Monthly Fees", "Admission Fees", "Bus Fees"],
      TypeFeesCollect: ["Select", "Paytm", "Cash On Delivery"],
      MonthlyCollecFee: [
        "Select",
        "Class 1 General",
        "Monthly Fees",
