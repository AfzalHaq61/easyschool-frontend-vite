      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Add Fees Group</button>
          </div>
        </form>
      </div>
    </div>
...
The money that you pay to be taught</textarea
                  >
                </div>
                <div class="d-flex align-items-center justify-content-between">
                  <div class="status-title">
...
export default {
  ...
  methods: {
    submitForm() {
      this.$router.push("/fees/fees-group");
    },
  },
};
</script>
