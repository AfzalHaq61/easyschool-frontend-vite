              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <vue-select :options="SelcCopu" id="selecCopu" placeholder="Select" />
                  </div>
                </div>
              </div>
            </div>
...
export default {
  data() {
    return {
      ExamChaSel: ["Select", "Week", "Monthly Test", "Chapter Wise Test"],
      SelcCopu: ["Select", "12 May 2024", "05 Jun 2024"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/examinations/exam-list");
    },
  },
  setup() {
