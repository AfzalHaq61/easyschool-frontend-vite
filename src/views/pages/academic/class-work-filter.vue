...
export default {
  data() {
    return {
      SelWorSel: ["Select", "I", "II", "III"],
      WorSecSelect: ["Select", "A", "B", "C"],
      WorkSyalSel: ["English", "Maths", "Physics"],
      MonSelWor: ["Select", "Monday", "Tuesday", "Wednesday"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/peoples/class-home-work");
    },
  },
  setup() {
