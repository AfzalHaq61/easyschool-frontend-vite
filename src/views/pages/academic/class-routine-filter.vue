              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <vue-select :options="SeceSele" id="secesele" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
...
export default {
  data() {
    return {
      DayRoSele: ["Select", "Monday", "Tuesday", "Wednesday"],
      RourRooSele: ["101", "102", "103"],
      TeachsSele: ["Erickson", "Mori", "Joseph"],
      SeceSele: ["Select", "A", "B", "C"],
      ClasSelec: ["Select", "I", "II", "III"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/peoples/class-routine");
    },
  },
  setup() {
