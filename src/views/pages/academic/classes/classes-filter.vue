              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <vue-select :options="ClasSelecOne" id="classelecone" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
                    <label class="form-label">Section</label>
                    <vue-select :options="ClassSece" id="classece" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
                    <label class="form-label">Status</label>
                    <vue-select :options="SeleSts" id="selests" placeholder="Select" />
                  </div>
                </div>
              </div>
            </div>
...
export default {
  data() {
    return {
      ClasSelecOne: ["I", "II", "III"],
      ClassSece: ["Select", "A", "B", "C"],
      SeleSts: ["Select", "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/classes/classes-list");
    },
  },
  setup() {
