              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <vue-select :options="TypeSele" id="typesele" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
                    <label class="form-label">Status</label>
                    <vue-select :options="ScheSts" id="schests" placeholder="Select" />
                  </div>
                </div>
              </div>
            </div>
...
export default {
  data() {
    return {
      TypeSele: ["Select", "Class"],
      ScheSts: ["Select", "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
