              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue-select :options="InSelNum" id="inselnum" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <vue-select :options="PaySele" id="paysele" placeholder="Select" />
                  </div>
                </div>
              </div>
            </div>
...
export default {
  data() {
    return {
      InSelNum: ["Select", "INV681537", "INV681536", "INV681535"],
      DateSelectIn: ["Select", "25 Apr 2024", "29 Apr 2024", "11 May 2024"],
      PaySele: ["Select", "Cash", "Credit", "Cash"],
    };
  },
  methods: {
    submitForm() {
