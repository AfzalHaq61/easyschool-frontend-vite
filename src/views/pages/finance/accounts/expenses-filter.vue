...
export default {
  data() {
    return {
      MonthlyExpense: ["Select", "Monthly Electriciy", "Teacher Salary", "AC Repair"],
      ExpenseCate: ["Select", "utilities", "Salaries", "Maintenance"],
      SelectInvoice: ["Select", "INV681537", "INV681536", "INV681535"],
    };
  },
  methods: {
    submitForm() {
