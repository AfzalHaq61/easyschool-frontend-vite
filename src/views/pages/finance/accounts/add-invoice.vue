        ...
        <div class="col-md-12">
          <form @submit.prevent="submitForm">
            ...
            <div class="text-end">
              ...
              <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Add Invoice</button>
            </div>
          </form>
        </div>
      </div>
...
export default {
  data() {
    return {
      ...
      text2: "Add Invoice",
      MariaSel: ["Select", "Ralph Claudia", "Julie Scott", "Maria"],
      InvoiSel: ["Select", "25 Apr 2024", "29 Apr 2024", "11 May 2024"],
      ProgrSel: ["Select", "STEM Program Grant"],
      DueSele: ["Select", "30 Apr 2024", "05 May 2024", "16 May 2024"],
    };
  },
  methods: {
    submitForm() {
