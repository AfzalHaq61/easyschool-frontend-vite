            ...
            >
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <span
                      class="avatar avatar-lg bg-warning rounded flex-shrink-0 me-2"
            ...
            >
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <span
                      class="avatar avatar-lg bg-success rounded flex-shrink-0 me-2"
            ...
            >
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <span
                      class="avatar avatar-lg bg-danger rounded flex-shrink-0 me-2"
            ...
            >
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <span
                      class="avatar avatar-lg bg-secondary rounded flex-shrink-0 me-2"
            ...
            <div class="card flex-fill">
              ...
              <div class="card-body">
                <div class="notice-widget">
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="overflow-hidden">
                        ...
                        <p>
                          <i class="ti ti-calendar me-2"></i>Added on : 11 Mar
                          2024
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="overflow-hidden">
                        ...
                        <p>
                          <i class="ti ti-calendar me-2"></i>Added on : 21 Apr
                          2024
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="overflow-hidden">
                        ...
                        <p>
                          <i class="ti ti-calendar me-2"></i>Added on : 13 Mar
                          2024
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="overflow-hidden">
                        ...
                        <p>
                          <i class="ti ti-calendar me-2"></i>Added on : 24 May
                          2024
                        </p>
                      </div>
                    </div>
                  ...
                  <div
                    class="d-sm-flex align-items-center justify-content-between mb-0"
                  >
                    <div
                      class="d-flex align-items-center overflow-hidden me-2 mb-2 mb-sm-0"
                    >
                ...
                <ul class="list-group list-group-flush todo-list">
                  <li class="list-group-item py-3 px-0 pt-0">
                    ...
                    >
                      ...
                      <span class="badge badge-soft-success mt-2 mt-sm-0"
                        >Compeleted</span
                      >
                    </div>
                  </li>
                  <li class="list-group-item py-3 px-0">
                    ...
                    >
                      ...
                      <span class="badge badge-soft-skyblue mt-2 mt-sm-0"
                        >Inprogress</span
                      >
                    </div>
                  </li>
