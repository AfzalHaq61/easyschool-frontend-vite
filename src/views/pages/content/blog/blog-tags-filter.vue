              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue-select :options="SelcTags" id="selctags" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
...
export default {
  data() {
    return {
      SelcTags: ["Select", "Guide", "Development", "Education"],
      DateAddedd: ["Select", "25 May 2024", "24 May 2024", "15 May 2024"],
      StatusBlogSele: ["Select", "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
