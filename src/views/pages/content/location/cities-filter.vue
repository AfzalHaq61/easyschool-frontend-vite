...
export default {
  data() {
    return {
      CitySelect: ["Select", "Los Angeles", "New York City", "Houston"],
      CityState: ["Select", "California", "New York", "Texas"],
      CountryCity: ["Select", "United States", "Germany", "Canada"],
      CityStatus: ["Select", "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
