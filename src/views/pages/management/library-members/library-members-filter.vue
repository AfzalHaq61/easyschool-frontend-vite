              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue-select :options="MembSlec" id="membslec" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
                    <label class="form-label">Card No</label>
                    <vue-select :options="CarSelec" id="carselec" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
...
export default {
  data() {
    return {
      MembSlec: ["Select", "James", "Garcia", "Frank", "Kevin", "Jennie"],
      CarSelec: ["Select", "501", "502", "503", "504"],
      FilteMemb: [
        "Filters",
        "Member",
        "Card No",
