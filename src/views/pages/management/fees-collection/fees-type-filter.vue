            ...
            <div class="p-3 border-bottom">
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    <label class="form-label">Name</label>
                    <vue-select :options="SeleName" id="selename" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
...
export default {
  data() {
    return {
      FeesTpyFilSel: ["Select", "FG80482", "FG80481", "FG80480"],
      NamSelFil: ["Select Name", "Janet", "Joann", "Kathleen"],
      SeleName: ["Select", "Janet", "Joann", "Kathleen"],
      SeFeesGro: [
        "Select Fees Group",
        "Tuition Fees",
        "Monthly Fees",
      ...
      AdmiTypeFil: [
        ...
        "Apr-Mar",
        "Bus Fees",
        "1st Installment Fees",
        "Topper  Discount",
        "3rd Installment Fees",
        "4th Installment Fees",
        "2nd Installment Fees",
      ],
      StaTypeActive: ["Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/fees/fees-type");
    },
  },
  setup() {
