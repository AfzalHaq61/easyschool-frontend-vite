              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue-select :options="GenSelec" id="genselec" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
                    <label class="form-label">Student Category</label>
                    <vue-select :options="Categoyj" id="categoyj" placeholder="Select" />
                  </div>
                </div>
              </div>
            </div>
...
export default {
  data() {
    return {
      SeceSelectr: ["Select", "A", "B", "C"],
      GenSelec: ["Select", "Male", "Female", "Both"],
      Categoyj: ["Select", "BC", "MBC", "FC", "BC"],
    };
  },
  methods: {
    submitForm() {
