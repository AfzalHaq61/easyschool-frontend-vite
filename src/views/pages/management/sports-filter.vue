...
export default {
  data() {
    return {
      SportName: ["Select", "Cricket", "Throwball", "Football", "Tennis", "Basketball"],
      CoachSelec: ["Select", "Thomas", "Georgia", "Nicholas", "Sandra"],
      MoreSports: ["Filters", "ID", "Name", "Coach", "Started Year"],
    };
  },
  methods: {
    submitForm() {
