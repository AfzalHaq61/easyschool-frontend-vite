              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue-select
                      :options="SecStudentReport"
                      id="secstudentreporttype"
                      placeholder="Select"
                    />
                  </div>
                </div>
...
export default {
  data() {
    return {
      StudReportType: ["Select", "I", "II", "III"],
      SecStudentReport: ["Select", "A", "B"],
      NameJanetReport: ["Select", "Janet", "Joann", "Kathleen"],
      AttendanTypeStud: ["Select", "Present", "Absent", "Half Day", "Holiday"],
      CountReportStud: ["Select", "24", "24", "24"],
    };
  },
  methods: {
    submitForm() {
