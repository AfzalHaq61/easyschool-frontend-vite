...
export default {
  data() {
    return {
      StaffReportDep: ["Select", "Management", "Finance"],
      NameReportStaff: ["Select", "Janet", "Joann", "Kathleen"],
      MonthStaffReports: ["Select", "March", "May"],
      DateMonthStafff: ["Select", "15 May 2024", "16 May 2024"],
    };
  },
  methods: {
    submitForm() {
