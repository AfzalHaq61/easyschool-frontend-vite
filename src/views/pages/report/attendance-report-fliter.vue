              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <vue-select :options="NaeJanet" id="naejanet" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
...
export default {
  data() {
    return {
      ClassReportAttend: ["Select", "I", "II", "III"],
      SeceRortAttend: ["Select", "A", "B", "C"],
      NaeJanet: ["Select", "Janet", "Joann", "Kathleen"],
      GendSeleOne: ["Select", "Male", "Female"],
      StatActiveReport: ["Select", "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
