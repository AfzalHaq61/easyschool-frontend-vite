...
export default {
  data() {
    return {
      ClassSlecRep: ["Select", "I", "II", "III"],
      SecStudentRepo: ["Select", "A", "B", "C"],
      JanetStudentRep: ["Select", "Janet", "Joann", "kathleen"],
      GendStudRep: ["Select", "Male", "Female"],
      StatStudRep: ["Select", "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
