                ...
                <div class="row row-cols-xxl-5 row-cols-md-6">
                  ...
                  <div class="col-xxl col-xl-3 col-md-6">
                    <div class="mb-3">
                      ...
                      <vue-select :options="SecSel" id="secsel" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-xxl col-xl-3 col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-xxl col-xl-3 col-md-6">
                    <div class="mb-3">
                      ...
                      <vue-select :options="OBCSel" id="obcsel" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-xxl col-xl-3 col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-xxl col-xl-3 col-md-6">
                    <div class="mb-3">
                      ...
                      <vue-select :options="EnglSel" id="englsel" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-xxl col-xl-3 col-md-6">
                    <div class="mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="mb-3">
                      ...
                      <vue-select :options="AMSel" id="amsel" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                    <div class="mb-3">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <vue-select :options="HISel" id="hisel" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Room No</label>
                      <vue-select :options="RoomSel" id="roomsel" placeholder="Select" />
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      ...
      YearSel: ["June 2024/25", "June 2023/24", "June 2023/23"],
      ActiveSel: ["Select", "Active", "Inactive"],
      StandSel: ["Select", "I", "II", "III", "IV", "V"],
      SecSel: ["Select", "A", "B"],
      GenderSel: ["Select", "Male", "Female"],
      BloodSel: ["Select", "O +ve", "B +ve", "B -ve"],
      HouseSel: ["Select", "Red"],
      ChristSel: ["Select", "Christianity", "Buddhism", "Irreligion"],
      OBCSel: ["Select", "OBC", "BC"],
      EnglSel: ["Select", "English", "Spanish"],
      NewYorkSel: ["Select", "Newyork", "Denver", "Chicago"],
      RollSel: ["Select", "35013", "35011", "35010"],
      AdmiSel: ["Select", "AD9892434", "AD9892433", "AD9892432"],
      ClassSel: ["select", "I", "II", "III"],
      RouteSel: ["Select", "Newyork", "Denver", "Chicago"],
      AMSel: ["Select", "AM 54548", "AM 64528", "AM 123548"],
      CincinSel: ["Select", "Cincinatti", "Illinois", "Morgan"],
      HISel: ["Select", "HI-Hostel, Floor", "HI-Hostel, 2nd Floor"],
      RoomSel: ["Select", "20", "22", "24", "26"],
      title: "Add Student",
      text: "Dashboard",
      text1: "Students",
      text2: "Add Student",
