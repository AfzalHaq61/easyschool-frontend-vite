              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <vue-select :options="ClassGuradGrid" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
...
export default {
  data() {
    return {
      GuradGrid: ["Select", "Janet", "Joann", "Kathleen"],
      ClassGuradGrid: ["Select", "I", "II", "III"],
      StatusGridSelect: ["Select", "Active", "Inactive"],
      GuardianGridSel: ["Select", "William", "Stacey", "George"],
    };
  },
  setup() {
  ...
  methods: {
    submitForm() {
      this.$router.push("/guardians/guardian-list");
    },
  },
};
</script>
