          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <div class="pass-group">
                <Field name="password" :type="showPassword ? 'text' : 'password'" v-model="password"
                  class="form-control pass-input mt-2" :class="{ 'is-invalid': errors.password }" />
                <span class="ti toggle-password" :class="showPassword ? 'ti-eye' : 'ti-eye-off'"
            ...
            <div class="mb-3">
              ...
              <div class="pass-group">
                <Field name="confirmPassword" :type="showConfirmPassword ? 'text' : 'password'"
                  v-model="confirmPassword" class="form-control pass-input mt-2"
                  :class="{ 'is-invalid': errors.confirmPassword }" />
                <span class="ti toggle-password" :class="showConfirmPassword ? 'ti-eye' : 'ti-eye-off'"
...
const submitForm = async () => {
  ...
  if (result.success) {
    // Clear notification to ensure clean state if Redirecting
    notification.value = null;
