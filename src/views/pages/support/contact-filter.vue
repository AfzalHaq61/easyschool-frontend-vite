              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <vue-select :options="ContCate" id="contcate" plaecholder="Select" />
                  </div>
                </div>
              </div>
            </div>
...
export default {
  data() {
    return {
      ContCate: ["Select", "Date", "Message", "Email"],

      ContQuest: [
        "Select",
        "Reminder: Staff meeting tomorrow.",
        "Sure, let's discuss it in class.",
