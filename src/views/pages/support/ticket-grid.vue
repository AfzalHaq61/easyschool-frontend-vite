            ...
            <div class="card">
              ...
              >
                ...
                <div class="d-flex align-items-center mb-1">
                  ...
                  <div class="mb-2">
                    <vue-select
                      :options="OnePublicMarkGrid"
                      id="onepublicmarkgrid"
                      placeholder="Mark as Private"
                    />
                  </div>
                </div>
            ...
            <div class="card">
              ...
              >
                ...
                <div class="d-flex align-items-center mb-1">
                  ...
                  <div class="mb-2">
                    <vue-select
                      :options="TwoPublicMarkGrid"
                      id="twopublicmarkgrid"
                      placeholder="Mark as Private"
                    />
                  </div>
                </div>
            ...
            <div class="card">
              ...
              >
                ...
                <div class="d-flex align-items-center mb-1">
                  ...
                  <div class="mb-2">
                    <vue-select
                      :options="ThreePublicMarkGrid"
                      id="threepublicmarkgrid"
                      placeholder="Mark as Private"
                    />
                  </div>
                </div>
...
export default {
  data() {
    return {
      ...
      text1: "Support",
      text2: "Tickets",
      PublicMarkGrid: ["Mark as Public", "Mark as Private"],
      OnePublicMarkGrid: ["Mark as Public", "Mark as Private"],
      TwoPublicMarkGrid: ["Mark as Public", "Mark as Private"],
      ThreePublicMarkGrid: ["Mark as Public", "Mark as Private"],
    };
  },
};
</script>
