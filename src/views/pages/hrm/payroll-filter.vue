              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue-select :options="PayMonth" id="paymonth" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-0">
                    <label class="form-label">Year</label>
                    <vue-select :options="PayYear" id="payyear" placeholder="Select" />
                  </div>
                </div>
              </div>
            </div>
...
export default {
  data() {
    return {
      SelectPay: ["Select", "Kevin", "Willie", "Daniel"],
      PayMonth: ["Select", "Aprill", "May", "June"],
      PayYear: ["Select", "2024", "2023", "2022"],
    };
  },
  methods: {
    submitForm() {
