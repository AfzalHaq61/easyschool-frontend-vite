...
export default {
  data() {
    return {
      TypeAprove: ["Select", "Medical Leave", "Casual Leave", "Maternity Leave"],
      RoleAprove: ["Select", "Student", "Teacher", "Admin"],
      DateAproveSel: [
        "Select",
        "05 May 2024 - 07 may 2024",
        "07 May 2024 - 07 may 2024",
        "08 May 2024 - 19 may 2024",
      ],
      SelectAproveSat: ["Select", "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
