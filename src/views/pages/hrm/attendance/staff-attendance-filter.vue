...
export default {
  data() {
    return {
      StaffIdSelect: ["Select", "T849127", "T849125", "T849126"],
      StaffNameSelect: ["Select", "Janet", "Joann", "Kathleen"],
      StaffDepSelect: ["Select", "Admin", "Management", "Finance"],
      DesignStaff: ["Select", "Technical Head", "Receptionist", "Accountant"],
    };
  },
  methods: {
    submitForm() {
