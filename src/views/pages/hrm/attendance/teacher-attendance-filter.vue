...
export default {
  data() {
    return {
      TeacherIdSel: ["Select", "T849127", "T849125", "T849126"],
      TeacherNameSel: ["Select", "Janet", "Joann", "Kathleen"],
      TeacherClassId: ["Select", "XI", "VII", "VIII"],
      TeacherAttendSel: ["Select", "Present", "Absent", "Late"],
    };
  },
  methods: {
    submitForm() {
