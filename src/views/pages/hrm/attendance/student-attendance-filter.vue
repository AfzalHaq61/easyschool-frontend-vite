...
export default {
  data() {
    return {
      SecAttendSele: ["Select", "A", "B", "C"],
      ClaAttendSel: ["Select", "XI", "VII", "VIII"],
      AttendSelect: ["Select", "Janet", "Joann", "Kathleen"],
      RolSelane: ["Select", "35004", "35005", "35006"],
      AdmissSele: ["Select", "AD9892424", "AD9892425", "AD9892426"],
    };
  },
  methods: {
    submitForm() {
