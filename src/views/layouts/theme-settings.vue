  ...
  <div class="sidebar-themesettings offcanvas offcanvas-end" id="theme-setting">
    ...
    <div class="bg-light-500 p-3">
      <div class="row gx-3">
        ...
        <div class="col-6">
          <a
            href="https://themeforest.net/item/EasySchool-bootstrap-admin-html-template/29532878"
            target="_blank"
...
export default {
  ...
  setup() {
    ...
    // Assign DOM elements to refs after the component mounts
    onMounted(() => {
      darkModeToggle.value = document.getElementById("darkTheme");
      lightModeToggle.value = document.getElementById("lightTheme");
  ...
  methods: {
    setupThemeSettings() {
      ...
      function resetThemeAndSidebarThemeAndColorAndBg() {
        ...
        document.getElementById("sidebarBg1").checked = true;
        // Clear sidebar and other selections
        localStorage.removeItem("sidebarBg");
      }
