          ...
          <div class="dropdown ms-1">
            <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
              <span class="avatar avatar-md rounded">
                <img :src="authStore.user?.attributes?.profile_photo_url || authStore.defaultAvatar" alt="Img"
                  class="img-fluid" />
              </span>
            </a>
            <div class="dropdown-menu">
              <div class="d-block">
                <div class="d-flex align-items-center p-2">
                  ...
                  <div>
                    <h6 class="">{{ authStore.user?.attributes?.name || 'User' }}</h6>
                    <p class="text-primary mb-0">{{ authStore.user?.attributes?.roles?.[0] || 'Administrator' }}</p>
                  </div>
                </div>
                <hr class="m-0" />
